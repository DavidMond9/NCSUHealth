    ...
    return (
        <div className="home-container">
            ...
            <div className="top-bar">
                <Link to="profile">
                    <img src={logo} alt="NCSU Health Logo" />
                </Link>
            </div>
            ...
            <nav className="bottom-nav">
                <Link to="profile">Profile</Link>
                <Link to="nutrition" className={profileComplete ? '' : 'disabled-link'} onClick={handleDisabledClick}>
                    Nutrition
                </Link>
                <Link to="exercise" className={profileComplete ? '' : 'disabled-link'} onClick={handleDisabledClick}>
                    Exercise
                </Link>
                <Link to="settings" className={profileComplete ? '' : 'disabled-link'} onClick={handleDisabledClick}>
                    Settings
                </Link>
            </nav>
        </div>
